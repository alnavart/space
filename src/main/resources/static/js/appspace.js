    ...
    gui: {
        ...
        receiveEvent: function (event) {
            ...
            if (jsonEvent.type == "CONNECT") {
                appspace.gui.addParticipant(jsonEvent.data);
            }
            else if (jsonEvent.type == "CONNECT") {
                appspace.gui.removeParticipant(jsonEvent.data);
            }
            else if (jsonEvent.type == "NEW_SPACECRAFT") {
                appspace.gui.addSpacecraft(jsonEvent.data);
            }
            else if (jsonEvent.type == "SPACECRAFT_DOWN") {
                appspace.gui.removeSpacecraft(jsonEvent.data);
            }
